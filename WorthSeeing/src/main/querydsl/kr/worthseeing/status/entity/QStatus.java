...
public class QStatus extends EntityPathBase<Status> {
    ...
    public final ListPath<kr.worthseeing.blockGroupReservation.entity.BlockGroupWaiting, kr.worthseeing.blockGroupReservation.entity.QBlockGroupWaiting> blockGroupWaitingList = this.<kr.worthseeing.blockGroupReservation.entity.BlockGroupWaiting, kr.worthseeing.blockGroupReservation.entity.QBlockGroupWaiting>createList("blockGroupWaitingList", kr.worthseeing.blockGroupReservation.entity.BlockGroupWaiting.class, kr.worthseeing.blockGroupReservation.entity.QBlockGroupWaiting.class, PathInits.DIRECT2);
